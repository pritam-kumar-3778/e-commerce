...
import { Button, LinearProgress, Rating, Box } from "@mui/material";
          ...
          <div className="lg:col-span-1 maxt-auto max-w-2xl px-4 pb-16 sm:px-6 lg:max-w-7xl lg:px-8 lg:pb-24">
            ...
            <div className="mt-4 lg:row-span-3 lg:mt-0">
              ...
              <div className="mt-6">
                ...
                <p className="opacity-40 hover:opacity-60 text-sm">6468 Ratings</p>
                <p className="ml-3 text-sm font-medium text-indigo-400 hover:text-indigo-600">567 Reviews</p>
                </div>
              ...
              <form className="mt-10">
                ...
                <Button onClick={handleAddToCart} variant="contained" sx={{px:"1.5rem",py:"0.5rem",bgcolor:"#9155fd",mt:"5px"}}>
                  Add to cart
                </Button>
              </form>
            </div>
...
{/* Ratings and reviews */}
        <section>
        <h1 className="font-semibold text-lg pb-4">Recent Reviews and ratingd</h1>
        ...
        <Grid container spacing={7}>
            ...
            <Grid item sx={5}>
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <p className="opacity-60 ">6768 ratings</p>
                </div>
